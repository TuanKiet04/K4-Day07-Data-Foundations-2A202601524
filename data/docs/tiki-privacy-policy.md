...
# Chính sách bảo mật thông tin cá nhân Tiki
...
Sàn giao dịch thương mại điện tử tiki.vn mong muốn đem lại một tiện ích mua hàng trực tuyến tin cậy, tiết kiệm và thấu hiểu người dùng.
Chúng tôi nhận thấy khách hàng sử dụng sàn giao dịch thương mại điện tử để mua sắm nhưng không phải ai cũng mong muốn chia sẻ thông tin cá nhân của mình. Chúng tôi, Công ty cổ phần Ti Ki, tôn trọng quyền riêng tư của khách hàng và cam kết bảo mật thông tin cá nhân của khách hàng khi khách hàng tin vào chúng tôi cung cấp thông tin cá nhân của khách hàng cho chúng tôi khi mua sắm tại sàn giao dịch thương mại điện tử tiki.vn. Đây là nguyên tắc khi tiếp cận quyền riêng tư, thông tin cá nhân tại sàn giao dịch thương mại điện tử tiki.vn.
...
(i) để cải thiện và cá nhân hóa trải nghiệm của bạn trên sàn giao dịch thương mại điện tử tiki.vn
...
• Bạn tương tác với chúng tôi. Chúng tôi sử dụng cookies và công nghệ theo dấu khác để thu thập một số thông tin khi bạn tương tác trên sàn giao dịch thương mại điện tử tiki.vn
• Từ những nguồn hợp pháp khác. Chúng tôi có thể sẽ thu thập thông tin cá nhân từ các nguồn hợp pháp khác.

4. Thời Gian Lưu Trữ
Thông tin cá nhân của khách hàng sẽ được lưu trữ cho đến khi khách hàng có yêu cầu hủy bỏ hoặc khách hàng tự đăng nhập và thực hiện hủy bỏ (Tham khảo mục 7). Trong mọi trường hợp thông tin cá nhân của khách hàng sẽ được bảo mật trên máy chủ của tiki.vn
...
1) Khách hàng có thể rút tên, xóa tên, yêu cầu truy cập hoặc điều chỉnh thông tin khách hàng đã cung cấp cho chúng tôi bằng cách nào?
• Khách hàng có thể rút tên, xóa tên, yêu cầu truy cập bằng cách xóa/hủy tài khoản Tiki của họ. Sau khi khách hàng xóa tài khoản, hệ thống sẽ xóa toàn bộ các dữ liệu cá nhân của khách hàng. Để xóa/hủy tài khoản Tiki, xem chi tiết tại https://tiki.vn/thong-tin/huong-dan-xoa-tai-khoan
• Để điều chỉnh các thông tin khách hàng đã cung cấp, khách hàng có thể vào Thông tin Tài khoản Tiki của họ và thực hiện Điều chỉnh thông tin. Chi tiết xem tại https://hotro.tiki.vn/s/article/Huong-dan-cap-nhat-thong-tin-tai-khoan

2) Yêu cầu Truy cập đến hoặc Sửa Dữ Liệu Cá Nhân
• Nếu Khách hàng đã đăng ký một tài khoản với chúng tôi, cá nhân khách hàng có thể truy cập và/hoặc sửa dữ liệu cá nhân của khách hàng mà chúng tôi đang lưu giữ hoặc kiểm soát thông qua trang Thiết Lập Tài Khoản. 
• Nếu Khách hàng chưa đăng ký tài khoản với chúng tôi, Khách hàng có thể yêu cầu truy cập và/hoặc sửa dữ liệu cá nhân của Khách hàng mà chúng tôi đang lưu giữ hoặc kiểm soát bằng cách gửi yêu cầu bằng văn bản cho chúng tôi. Chúng tôi sẽ cần có đủ thông tin từ bạn để xác định danh tính của Khách hàng cũng như bản chất yêu cầu của Khách hàng để có thể giải quyết yêu cầu. Do đó, vui lòng gửi yêu cầu bằng văn bản của bạn bằng cách gửi email cho nhân viên Quản lý dữ liệu của chúng tôi tại đây.
...
3) Làm cách nào để tôi xóa/hủy tài khoản Tiki của mình?
Để xoá/huỷ tài khoản Tiki xem chi tiết tại https://tiki.vn/thong-tin/huong-dan-xoa-tai-khoan
...
Hoặc có thể liên hệ trực tiếp với chúng tôi tại đây

9. Đơn Vị Thu Thập và Quản Lý Thông Tin
Công ty Cổ phần Ti Ki
Thành lập và hoạt động theo Giấy chứng nhận Đăng ký Kinh doanh số 0309532909 do Sở Kế hoạch và Đầu tư Thành phố Hồ Chí Minh cấp lần đầu ngày 06/01/2010 và sửa đổi lần thứ 23 ngày 14/02/2022
Trụ sở chính: Tòa nhà Viettel, Số 285, đường Cách Mạng Tháng 8, phường 12, quận 10, Thành phố Hồ Chí Minh

10. Hiệu lực
Bản cập nhật Chính Sách Bảo Mật Thông Tin Cá Nhân này có hiệu lực từ ngày 11/11/2022
